...
<div style=" width:100%; max-width:400px; margin: 0 auto;"> 
  <TABLE class="w3-table w3-white w3-border">
    <TR>
      <TH class="w3-teal w3-text-white w3-wide" style="width:40%; font-size:16px; text-shadow:1px 1px 0 #444;">아이디</TH>
      <TD><input class="w3-input" type="text" name="id" size="20" placeholder="ID를 입력하세요." required></TD>
    </TR>
  </TABLE>
</div>
<br>
