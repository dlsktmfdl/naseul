...
<div  class="w3-panel w3-border-top w3-border-bottom w3-border-green" style="margin:0 auto; width:50%; max-width:200px; font-size: x-large; text-align: center;">
약관 동의
</div><br>
<center>
<textarea readonly  style="width:90%; max-width:600px; height:400px; font-size: 14px">Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
<div style="text-align: center"> 
  ...
  <input class="w3-btn w3-white w3-border w3-border-teal w3-padding-small" type="submit" value="회원가입"></input>  
  <input class="w3-btn w3-white w3-border w3-border-teal w3-padding-small" type="button" value="취소" onclick="history.back();" /> 
</div> 
</form> 
